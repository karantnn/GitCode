...
# Robust .env loading: prefer project .env and override existing env vars
def _load_env():
...
from cli.agents import agent_app
...
app.add_typer(agent_app, name="agent", help="Run individual agents with independent outputs")
